...
Notes
- The client keystore/truststore locations are configured as a Spring SSL bundle (`mtls-client`) in service/src/main/resources/application.properties and point to target/generated-certs:
